...
class Itdelight_Callback_Block_Adminhtml_Callback_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status', array(
            ...
            'index'   => 'status',
            'type'    => 'options',
            'options' => Mage::getModel('itdelight_callback/System_Config_Source_Yesno')->toArray(),
    ...
    protected function _prepareMassaction()
    {
        ...
        $statuses = Mage::getModel('itdelight_callback/System_Config_Source_Yesno')->toOptionArray();
